...
<html lang="FA" dir="RTL">
    <head>        
        ...
        <title>آزمون های دکتر تست</title>
...
$(document).ready(function () {
    $("#filter-categorya :checkbox").click(function () {
        ...
        $("#filter-categorya :checkbox:checked").each(function () {                                
            ...
            $("#filter-categorya").load("packageFilter.php", {q: 'کنکور'});
    ...
    <body style='background: #fbfcf9'>
        <div class="container-fluid">
            <div class="row">
                ...
                $packageType = filter_input(INPUT_GET, 'packageType', FILTER_SANITIZE_STRING);

                if (isset($temp) && $temp === "addtocart") {
                    if (isset($packageId)) {
                        // new iem selected
                        if (!isset($_SESSION['cart'])) {
                            // $_SESSION['cart'] is associative array that packageId => qty                
                            $_SESSION['cart'] = array();
                    ...
                    foreach ($_SESSION['cart'] as $key => $value) {
                        if ($packageId == $value['packageId']) {
                            $test = true;
                        }
                    }
                    if (!$test) {
                        // if(!empty($_POST["quantity"])) {                                              
                        $_SESSION['cart'][] = mysqli_fetch_assoc(getpackageById($conn, $packageId));
                        $_SESSION['total_price'] = $_SESSION['total_price'] + getpackageprice($packageId);
                        $string = ' بسته' . $packageId . '   به سبد اضافه شد';
                        ...
                        $string = ' بسته' . $packageId . ' قبلا انتخاب شده است';
                ...
                <div class="hidden-lg hidden-md col-sm-12 col-xs-12">
                    <div class="well well-ms" style="background: green; margin:10px">
                        <a href="./packages.php">
                            <h1 style="text-align: center;color:white"> لیست بسته ها</h1>
                        </a>
                    </div>
                    <div id="carsitems" >
                        <?php include('packageFilter.php'); ?>
<!--                        <script type="text/javascript">
                            $(document).ready(function () {
                            $("#new_items").load("packageFilter.php", {q: '
                        <?php //echo $q  ?>'});
                            });
                        </script>-->
                    </div>
                ...
                <div>
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" >                        
                        <div class="quandanswers" style="text-align: center; margin-bottom: 0.3em; background: red; border-radius: 0.3em;">
                            <a href="questionsandanswers.php"><h1 style="color: white;">
                                    ...
                                    <br>
                                    کلیک کنید
                                    <span class="glyphicon glyphicon-question-sign"></span></h1></a>
                        </div>
                        <!--                        
                                                <div class="panel-primary" style="border-radius: 0.3em;">
                                                    <div class="panel-heading" style=" border-radius: 0.3em;background-color: blue">                                
                                                        <h1 style="text-align: center">فیلتر  بسته ها<span class="glyphicon glyphicon-filter"></span></h1>
                                                    </div>
                                                    <div class="panel-body" style="border:3px solid blue ;  border-radius: 0.3em;">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                ...
                                                                <label for="filter-categoryc"> کتابها و بسته های آموزشی</label>
                                                            </li>    
                                                        </ul>
                                                    </div>
                                                </div>-->
                    ...
                    <div id="carsitems" class="col-lg-9 col-md-9 hidden-sm hidden-xs">
                        <div class="col-md-12">
                            <div class="well well-ls clearfix" style="padding: 0px;margin-bottom: 0px;text-align: center;background: #FFE300"><h1>جدیدترین بسته ها</h1> </div>
                            <div class="well">
                                    ...
                                    <div class="carousel carousel-inner">
                                        <div class="item active">
                                            <div id="new_items" class="row">
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $("#new_items").load("packages_load_new.php?test=1");
                                                    });
                                                </script>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item">
                                            <div id="new_items2" class="row">
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $("#new_items2").load("packages_load_new.php?test=2");
                                                    });
                                                </script>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item">
                                            <div id="new_items3" class="row">
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $("#new_items3").load("packages_load_new.php?test=3");
                                                    });
                                                </script>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="well well-ls clearfix" style="padding: 0px;margin-bottom: 0px;text-align: center;background: #FFE300"><h1>بیشترین بسته های دانلود شده</h1> </div>
                            <div class="well"> 
                                    ...
                                    <div class="carousel carousel-inner">
                                        <div class="item active">
                                            <div id="top_items" class="row">
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $("#top_items").load("packages_load_top.php?test=1");
                                                    });
                                                </script>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item">
                                            <div id="top_items2" class="row">
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $("#top_items2").load("packages_load_new.php?test=2");
                                                    });
                                                </script>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div id="top_items3" class="row">
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $("#top_items3").load("packages_load_new.php?test=3");
                                                    });
                                                </script>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="well well-ls clearfix" style="padding: 0px;margin-bottom: 0px;text-align: center;background: #FFE300"><h1>محبوب ترین بسته ها</h1> </div>
                                    ...
                                    <div class="carousel carousel-inner">
                                        ...
                                        <div class="item active">
                                            <div id="best_items" class="row">
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $("#best_items").load("packages_load_best.php?test=1");
                                                    });
                                                </script>
                                            </div><!--/row-fluid-->
                                        </div><!--/item-->
                                        ...
                                        <div class="item">
                                            <div id="best_items2" class="row">
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $("#best_items2").load("packages_load_best.php?test=2");
                                                    });
                                                </script>
                                            </div><!--/row-fluid-->
                                        </div><!--/item-->
                                        ...
                                        <div class="item">
                                            <div id="best_items3" class="row">
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $("#best_items3").load("packages_load_best.php?test=3");
                                                    });
                                                </script>
                                            </div><!--/row-fluid-->
                                        </div><!--/item-->
